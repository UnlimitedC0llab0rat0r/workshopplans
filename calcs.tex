...
The structure has an overhang on both sides, which we take to be 24 (cf \Cref{posts-rafters-assumptions}), and this allows us to calculate $x_8$ in the diagram: 
