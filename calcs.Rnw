...
\begin{align*}
dpct = 5.853 \implies \phi = 8\\
dpct = 10 \implies \phi = 10.0395
\end{align*}
...
Lengths:
\begin{enumerate}
  \item Post: \Sexpr{post_height_total_imperial}
  \item Rafter: \Sexpr{rafter_length_final_imperial}
  \item Kingpost: \Sexpr{kp_total_height_imperial}
  \item Collar Tie: \Sexpr{collar_tie_length_imperial}
  \item Struts: \Sexpr{strut_length_imperial}
  \item Braces: \Sexpr{brace_total_length_imperial}
\end{enumerate}
